        ...
        <div class="col-sm-4">
            ...
            <div class="panel panel-default">
                <div class="panel-body">
                    <form action='${pageContext.request.contextPath}/signin' style="width:300px" method = "post" id="myForm">
            ...
            <p>
                <a href="${pageContext.request.contextPath}/reg">Зарегистрироваться</a><br>
            </p>
        </div>
        <div class="col-sm-4">
        </div>
